$(document).ready(function(){
	...
	var ProcessContainer = {
			...
			setTimeout(function () {
				$('.class123').hide();
				BotMessageContainer.BotMessage('Holaa!!!');
				BotMessageContainer.BotMessage('for any futher details contact us on social media accounts ;)');
  ...
  $("#closebutton").click(function(e){
    ...
    $(".StartChat").click(function(){
      ...
      $('#closebutton').fadeOut({ queue: false, duration: 200 });
		...
		BotMessageContainer.BotMessage('This is SAM.');
     BotMessageContainer.BotMessage('Need any help?');
